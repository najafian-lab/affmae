...
from .dispatch import NUM_STAGES_OPTIONS, clamp_num_stages
...
@triton.heuristics(values={
    ...
    'num_stages': lambda args: clamp_num_stages(2)
})
@triton.jit
...
@triton.heuristics(values={
    ...
    'num_stages': lambda args: clamp_num_stages(4)
})
@triton.jit
...
def launch_flash_nbhood_attn_fwd(q, k, v, member_index, sm_scale, bias=None, mask=None,blank_k=None, blank_v=None, exp2=False):
    """Launch the v1 fused forward kernel.
    ...
    Args:
        ...
        exp2: use base-2 exponentials in the softmax.
    Returns:
...
def launch_flash_nbhood_attn_bwd(
    ...
    """Launch the v1 fused backward kernels.
